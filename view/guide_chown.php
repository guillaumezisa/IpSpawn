  ...
  <div class='row'>
    ...
    <div class='col-sm-10'>
      <div class='text-light bg-info' style='width:100%;border:solid black 1.5px;border-radius:4px; margin: 30px auto;'>
        ...
        Si vous voulez changer le propriétaire du dossier ouvrez un terminal allez dans le dossier et tapez pwd vous aurez le chemin.<br>
        Pour les fichiers mettez vous dans le dossier faites pwd copier le chemin ici et rajouter le nom du fichier derrière le /.<br><br>
      </div>
    </div>
  </div>
<div class='col-sm-1'></div>
