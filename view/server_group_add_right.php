...
<script>
  ...
  function append(event){
    ...
    var text_q = document.createTextNode(' Nom du groupes : ');
    var text_a = document.createTextNode(' Commandes autorisé : ')
    var text_b = document.createTextNode(' Commandes non autorisé : ')
    input_q.type = "text";
    input_q.name ="groupname[]";
    input_q.required = true;
    input_a.type = "text";
    input_a.name ="commandyes[]";
    input_a.required = true;
    input_b.type = "text";
    input_b.name ="commandno[]";
