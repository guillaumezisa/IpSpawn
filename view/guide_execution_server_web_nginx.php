  ...
  <div class='row'>
    ...
    <div class='col-sm-10'>
      <div class='text-light bg-info' style='width:100%;border:solid black 1.5px;border-radius:4px; margin: 30px auto;'>
        <br><h4>Prérequis : </h4>
        - Si vous avez déjà installé apache2 vous devez le désinstaller avec les commandes suivantes :<br>
        ...
        - Pour désinstaller nginx écrivez : apt purge nginx , apt autoremove<br><br>
        </div>
      </div>
    </div>
  <div class='col-sm-1'></div>
